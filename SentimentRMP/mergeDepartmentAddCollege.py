...
def addCollege(csv):
    ...
    for index, row in df.iterrows():
        ...
        if row['Department'] in ['Biological Sciences', 'Aerospace Studies', 'Biology', 'Science', 'Microbiology', 'Natural Sciences', 'Chemistry', 'Physical Sciences', 'Physics  Astronomy', 'Physics amp Astronomy', 'Biochemistry', 'Geology', 'Physical Sciences', 'Mathematics', 'Physics', 'Physics & Astronomy', 'Astronomy', 'Science Education']:
